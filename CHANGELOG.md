...
* Updating references to dashboard / API [Gareth Davies]
* Remove UART line as only added on dev images [Gareth Davies]
* Adding note to Pi docs for dtoverlay configuration [Gareth Davies]
* Updating UART and config vars [Gareth Davies]
* Addressing lurch review commits [Gareth Davies]
